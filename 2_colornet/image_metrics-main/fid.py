...
def _compute_statistics_of_path(path, model, batch_size, dims, cuda):
    if path.endswith('.npz'):
        ...
        import numpy as np
        imgs = np.array(
            [transform.resize(io.imread(str(fn)), target_size, mode='constant').astype(np.float32) for fn in files])
...
if __name__ == '__main__':
    ...
    clean = 'D://anconda//shibie//ca'
    noisy = 'D://anconda//shibie//ddcolor/out'
